...
<head>
  ...
  <meta name="description" content="Explore the latest fashion trends at MyShop - Clothing, Shoes, Accessories, and more.">
  <meta name="keywords" content="fashion, clothing, shoes, accessories, online shopping, Ethiopia">
  <title>Fashion - MyShop</title>
...
<body>
  ...
  <header>
    <nav class="sticky-nav">
      ...
      <ul class="nav-links">
        ...
        <li><a href="fashion.php" class="active"><i class="fas fa-tshirt"></i> Fashion</a></li>
  ...
  <section class="fashion-hero">
    <div class="hero-content">
      ...
      <p>Discover stylish clothing, shoes, and accessories to elevate your wardrobe.</p>
  ...
  <section id="featured-products" class="featured-products">
    ...
    <div class="product-grid">
      ...
      <div class="product-card">
        ...
        <img src="images/Men's T-Shirt.jfif"alt="Men's T-Shirt" class="product-image">
        <h3>Men's T-Shirt</h3>
      ...
      <div class="product-card">
        ...
        <img src="images/Women's Dress.jpg" alt="Women's Dress" class="product-image">
        <h3>Women's Dress</h3>
        <div class="product-rating">
      ...
      <div class="product-card">
        <div class="product-badge">New</div>
        <img src="images/Running Shoes.webp" alt="Running Shoes" class="product-image">
        <h3>Running Shoes</h3>
        <div class="product-rating">
      ...
      <div class="product-card">
        <div class="product-badge">Discounted</div>
        <img src="images/leatherjacket.jfif" alt="Leather Jacket" class="product-image">
      ...
      <div class="product-card">
        <div class="product-badge">New</div>
        <img src="images/handbag.jpg" alt="Handbag" class="product-image">
        <h3>Handbag</h3>
        <div class="product-rating">
      ...
      <div class="product-card">
        <div class="product-badge">Discounted</div>
        <img src="images/Sunglasses.jpg" alt="Sunglasses" class="product-image">
        <h3>Sunglasses</h3>
        <div class="product-rating">
