...
<header>
    <nav class="sticky-nav">
      ...
      <ul class="nav-links">
        ...
        <li><a href="fashion.php"><i class="fas fa-tshirt"></i> Fashion i></a></li>
        ...
        <?php else: ?>
            ...
            <li><a href="signup.php"><i class="fas fa-user-plus"></i> Register</a></li>
        <?php endif; ?>
      </ul>
      <a href="payment.php">
        <div class="cart-icon">
...
<section class="carousel">
    <div class="carousel-item active">
      <img src="https://cdn.pixabay.com/photo/2022/09/05/02/42/watch-7433126_1280.jpg" alt="Featured Product 1 - Electronics Sale">
    ...
    <div class="carousel-item">
      <img src=" https://cdn.pixabay.com/photo/2015/01/15/15/02/handbag-600398_960_720.jpg" alt="Featured Product 2 - Fashion Sale">
      <div class="carousel-text">
  ...
  <section class="featured-products">
    ...
    <div class="product-grid">
      ...
      <div class="product-card">
        ...
        <img src="https://www.designbolts.com/wp-content/uploads/2020/02/True-Wireless-Earbuds-with-Magic-HiFi-Sound-Zamkol-Waterproof-5.0-Bluetooth.jpg" alt="Product 1 - Wireless Earbuds" class="product-image">
      ...
      <div class="product-card">
        ...
        <img src="https://images-static.nykaa.com/media/catalog/product/0/4/043484bNoiseFitMettleEliteNickel_5.jpg" alt="Product 2 - Smartwatch" class="product-image">
        <h3>Smartwatch</h3>
        <div class="product-rating">
      ...
      <div class="product-card">
        <div class="product-badge">New</div>
        <img src="https://item-shopping.c.yimg.jp/i/l/vivasports_m-j1ga223709" alt="Product 3 - Running Shoes" class="product-image">
        <h3>Running Shoes</h3>
        <div class="product-rating">
      ...
      <div class="product-card">
        <div class="product-badge">Discounted</div>
        <img src="https://th.bing.com/th/id/R.0fbb22f2df9fb762f4fc16965791ac07?rik=j0FzTks1jzMsRw&pid=ImgRaw&r=0" alt="Product 4 - Leather Jacket" class="product-image">
      ...
      <div class="product-card">
        <div class="product-badge">New</div>
        <img src="https://img.freepik.com/premium-photo/yoga-mat_9493-16886.jpg" alt="Product 5 - Yoga Mat" class="product-image">
        <h3>Yoga Mat</h3>
        <div class="product-rating">
      ...
      <div class="product-card">
        <div class="product-badge">Discounted</div>
        <img src="https://tse1.mm.bing.net/th?id=OIP.tYM63JRcLfelVo7rUx-PIwHaIg&w=1161&h=1333&rs=1&pid=ImgDetMain" alt="Product 6 - Coffee Maker" class="product-image">
        <h3>Coffee Maker</h3>
        <div class="product-rating">
